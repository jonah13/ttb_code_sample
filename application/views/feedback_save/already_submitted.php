...
<body>
	<div id="main">
		...
		<div id="body">
			...
			<h2 style="font-size:24px;">Your comment for <mark><?php echo $location_name.' ('.$code.')'; ?> </mark> was already submitted, you can close your browser. Thank you</h2>
			</section>
		</div>
		<footer>
